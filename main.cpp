...
// gets a clean, obvious error instead of a silent duplicate-symbol link error.
//
// If you see this message and the project fails to link, remove main.cpp from
// the ClCompile list in the .vcxproj and add the three files above instead.
// =============================================================================